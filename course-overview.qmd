...
<!-- ## <span class="bi bi-piggy-bank content-icon" aria-hidden="true"></span> FCF description. -->
...
## <span class="bi bi-credit-card content-icon" aria-hidden="true"></span> Course description
...
The main textbooks recommended for this course are @Hull11 and @HullRM5, which cover influential credit risk models used in the financial industry. Additional references include @drake2010basics, @crouhy2014essentials, and @brealey2020principles, which provide broader discussions of risk in financial markets. The course also uses @lozanoARF, which bridges theoretical model analysis and practical computational modeling using R. Complementary references include @hull2020machine and @james2013introduction.

This <span class="bi bi-spotify content-icon" aria-hidden="true"></span> [Spotify podcast](https://open.spotify.com/episode/7hrOh0tvDH3lioOfXtRqsT?si=8142007bc6ab4f56) provides additional context on financial risk.
...
1. **Understand the course topics.** Students are expected to develop a solid understanding of the models, techniques, and principles covered in the course, especially in financial economics, financial risk management, and quantitative finance.
